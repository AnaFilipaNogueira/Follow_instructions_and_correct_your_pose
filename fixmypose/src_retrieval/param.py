...
def parse_args():
    ...
    # Principal
    parser.add_argument('--dataset', type=str, default='yoga')
    ...
    parser.add_argument('--alteracoes', type=str, default=None)
    parser.add_argument('--cutout_p', type=float, default=0.5)
    parser.add_argument('--nlpaug_choice', type=str, default=None)
    parser.add_argument('--aug_p', type=float, default=0.5)
    parser.add_argument('--choose_stop_words', type=str, default='False')
