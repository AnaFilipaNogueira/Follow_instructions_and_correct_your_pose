...
class Speaker:
    ...
    def train(self, train_tuple, eval_tuple, num_epochs, rl=False):
        ...
        for epoch in range(num_epochs):
            ...
            wandb.log({"loss": loss})
            wandb.log({"eval_train_score": scores})
            
            #if abs(scores-best_train_score) <= 0.01:
            #    num_not_improving_epochs += 1
            #    if num_not_improving_epochs == 15:
            #        break

            #if scores > best_train_score:
            #    best_train_score = scores
            #    num_not_improving_epochs = 0
            ...
            if epoch % 1 == 0:
                ...
                wandb.log({"eval_val_scores": scores})
    ...
    def teacher_forcing(self, src, trg, inst, leng, ans_id, train=True):
        ...
        wandb.log({"teacher_loss": loss, "teacher_scores": scores})
    ...
    def evaluate(self, eval_tuple, iters=-1):
        ...
        wandb.log({"scores_evaluate": scores, "eval_recall_1": scores_1rank, "eval_recall_3": scores_3rank, "eval_recall_5": scores_5rank})
        return scores
