...
wandb.init(
    ...
    project="fixmypose_hindi_ret_False",
)
...
if 'speaker' in args.train:
    ...
    if args.load is not None:
        ...
        scores = speaker.evaluate(valid_tuple)
        print("The validation result is:", scores.mean())
        wandb.log({"valid_scores": scores, "valid_scores_mean": scores.mean()})
    ...
    if args.train == 'rlspeaker':
        ...
        scores = speaker.evaluate(test_tuple)
        print("Test:", scores)
